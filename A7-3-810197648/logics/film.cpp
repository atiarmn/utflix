...
void Film::delete_film(std::map<std::string,std::string> informations){
...
std::vector<Film*> Film::get_films(User* logedin_user){
	return service->get_films(logedin_user);
}
std::vector<Film*> Film::get_published(User* logedin_user,std::map<std::string,std::string> informations){
	if(!(logedin_user->get_type()))
		throw PermissionDen();
	return service->get_published_films(logedin_user,informations);
}
std::vector<Film*> Film::get_purchased(User* logedin_user){
	return service->get_purchased(logedin_user);
}
